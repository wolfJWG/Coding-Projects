...
__function_main:
  ...
  mov [BP-18], R0
__while_1429_start:
__while_1429_continue:
  mov R0, 1
  jf R0, __while_1429_end
  mov R2, 123
  mov [SP], R2
  mov R2, 172
  mov [SP+1], R2
...
__if_1461_start:
  ...
  iadd R1, 20
  ile R0, R1
  jf R0, __LogicalAnd_ShortCircuit_1478
  mov R1, [BP-14]
  mov R2, [BP-12]
  idiv R2, 2
  iadd R1, R2
  ...
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_1478:
...
__LogicalAnd_ShortCircuit_1493:
  jf R0, __LogicalAnd_ShortCircuit_1509
  mov R1, [BP-13]
  mov R2, [BP-11]
  idiv R2, 2
  iadd R1, R2
  ...
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_1509:
  jf R0, __if_1461_end
  mov R0, [BP-16]
  imul R0, -1
  mov [BP-16], R0
...
__if_1572_start:
  ...
  iadd R1, 620
  ile R0, R1
  jf R0, __LogicalAnd_ShortCircuit_1589
  mov R1, [BP-14]
  mov R2, [BP-12]
  idiv R2, 2
  iadd R1, R2
  ...
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_1589:
  jf R0, __LogicalAnd_ShortCircuit_1604
  mov R1, [BP-13]
  mov R2, [BP-11]
  idiv R2, 2
  isub R1, R2
  ...
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_1604:
  jf R0, __LogicalAnd_ShortCircuit_1620
  mov R1, [BP-13]
  mov R2, [BP-11]
  idiv R2, 2
  iadd R1, R2
  ...
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_1620:
  jf R0, __if_1572_end
  mov R0, [BP-16]
  imul R0, -1
  mov [BP-16], R0
...
__if_1836_start:
  ...
  mov R1, [BP-12]
  ile R0, R1
  jt R0, __LogicalOr_ShortCircuit_1844
  mov R1, [BP-14]
  mov R2, [BP-12]
  isgn R2
  iadd R2, 640
...
__if_1855_start:
  ...
  mov R1, [BP-11]
  ile R0, R1
  jt R0, __LogicalOr_ShortCircuit_1863
  mov R1, [BP-13]
  mov R2, [BP-11]
  isgn R2
  iadd R2, 360
