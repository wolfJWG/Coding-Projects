...
__if_1884_start:
  mov R0, [BP+2]
  ieq R0, -1
  jf R0, __if_1884_else
  mov R0, 0
  jmp __function_getHeight_return
  jmp __if_1884_end
__if_1884_else:
  mov R2, [BP+2]
  iadd R2, 1
...
__function_minValueNode:
  ...
  mov [BP-1], R0
__while_1923_start:
__while_1923_continue:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_1925
  mov R2, [BP-1]
  iadd R2, 1
  mov R1, [R2]
  ine R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_1925:
  jf R0, __while_1923_end
  mov R1, [BP-1]
  iadd R1, 1
  mov R0, [R1]
  mov [BP-1], R0
  jmp __while_1923_start
__while_1923_end:
  mov R0, [BP-1]
__function_minValueNode_return:
  pop R2
  pop R1
  mov SP, BP
  pop BP
...
__if_1940_start:
  ...
  jf R0, __if_1940_end
  mov R0, [BP+2]
  jmp __function_deleteNode_return
__if_1940_end:
__if_1947_start:
  mov R0, [BP+3]
  mov R2, [BP+2]
...
__if_2027_start:
  ...
  ieq R0, -1
  jf R0, __if_2027_end
  jmp __function_displayTree_return
__if_2027_end:
__if_2035_start:
  mov R0, 0
  jf R0, __if_2035_else
  mov R3, [BP+2]
  mov [SP], R3
  call __function_getHeight
  mov R2, R0
...
__if_2035_end:
  ...
  mov [SP+3], R1
  call __function_displayTree
__function_displayTree_return:
  mov SP, BP
  pop BP
  ret

__function_findNodeByPosition:
  push BP
  mov BP, SP
  isub SP, 2
  push R1
...
__if_2108_start:
  ...
  jf R0, __if_2108_end
  mov R0, -1
  jmp __function_findNodeByPosition_return
__if_2108_end:
  mov R0, 15
  mov [BP-1], R0
__if_2118_start:
  ...
  isub R1, R2
  ige R0, R1
  jf R0, __LogicalAnd_ShortCircuit_2126
  mov R1, [BP+3]
  mov R3, [BP+2]
  iadd R3, 3
  mov R2, [R3]
  ...
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_2126:
  jf R0, __LogicalAnd_ShortCircuit_2133
  mov R1, [BP+4]
  mov R3, [BP+2]
  iadd R3, 4
  mov R2, [R3]
  ...
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_2133:
  jf R0, __LogicalAnd_ShortCircuit_2140
  mov R1, [BP+4]
  mov R3, [BP+2]
  iadd R3, 4
  mov R2, [R3]
  ...
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_2140:
  jf R0, __if_2118_end
  mov R0, [BP+2]
  jmp __function_findNodeByPosition_return
__if_2118_end:
  ...
  mov R1, [BP+4]
  mov [SP+2], R1
  call __function_findNodeByPosition
  mov [BP-2], R0
__if_2156_start:
  mov R0, [BP-2]
  ieq R0, -1
...
__if_2156_end:
  mov R0, [BP-2]
__function_findNodeByPosition_return:
  iadd SP, 3
  pop R3
  pop R2
  pop R1
...
__for_2175_continue:
  ...
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_2175_start
__for_2175_end:
__function_bubbleSort_return:
  mov SP, BP
  pop BP
  ret

__function_createSortedArray:
  push BP
  mov BP, SP
  isub SP, 105
  mov R0, 0
...
__for_2241_end:
  ...
  iadd R0, R1
  mov R0, [R0]
  mov [global_randomValue], R0
  mov R1, [BP+2]
  mov [SP], R1
  mov R1, [BP+3]
  mov [SP+1], R1
  call __function_bubbleSort
__function_createSortedArray_return:
  mov SP, BP
  pop BP
  ret

__function_sortedArrayToTree:
  push BP
  mov BP, SP
  isub SP, 2
  push R1
...
__if_2293_start:
  ...
  mov R1, [BP+4]
  igt R0, R1
  jt R0, __LogicalOr_ShortCircuit_2305
  mov R1, 1
  jf R1, __LogicalAnd_ShortCircuit_2302
  mov R2, [BP+5]
  ige R2, 4
  and R1, R2
__LogicalAnd_ShortCircuit_2302:
  or R0, R1
__LogicalOr_ShortCircuit_2305:
  jf R0, __if_2293_end
  mov R0, -1
  jmp __function_sortedArrayToTree_return
__if_2293_end:
  mov R0, [BP+3]
  mov R1, [BP+4]
  iadd R0, R1
  ...
  iadd R2, 1
  mov [SP+3], R2
  call __function_sortedArrayToTree
  mov R1, R0
  mov R2, [BP-2]
  iadd R2, 1
  mov [R2], R1
  ...
  mov R0, R1
  mov R0, [BP-2]
__function_sortedArrayToTree_return:
  iadd SP, 4
  pop R2
  pop R1
  mov SP, BP
...
__if_2351_start:
  ...
  jf R0, __if_2351_end
  mov R0, -1
  jmp __function_createTreeFinal_return
__if_2351_end:
__if_2358_start:
  mov R0, 1
  jf R0, __LogicalAnd_ShortCircuit_2363
  mov R1, [BP+2]
  igt R1, 4
  and R0, R1
__LogicalAnd_ShortCircuit_2363:
  jf R0, __if_2358_end
  mov R0, 4
  mov [BP+2], R0
__if_2358_end:
  ...
  mov R1, [BP-1]
  mov [SP+1], R1
  call __function_createSortedArray
  mov R1, [BP-2]
  mov [SP], R1
  mov R1, 0
  mov [SP+1], R1
  ...
  call __function_free
  mov R0, [BP-3]
__function_createTreeFinal_return:
  iadd SP, 4
  pop R2
  pop R1
  mov SP, BP
...
__function_main:
  ...
  mov R2, 5
  mov [SP], R2
  call __function_createTreeFinal
  mov R1, R0
  mov [BP-1], R1
  mov R0, R1
  mov R1, 0
...
__if_2456_start:
  ...
  iadd R0, R1
  ige R0, 0
  jf R0, __LogicalAnd_ShortCircuit_2465
  mov R1, [BP-2]
  mov R2, [BP-4]
  mov R3, [BP-9]
  imul R2, R3
  ...
  ile R1, 630
  and R0, R1
__LogicalAnd_ShortCircuit_2465:
  jf R0, __if_2456_end
  mov R0, [BP-2]
  mov R1, [BP-4]
  mov R2, [BP-9]
...
__if_2478_start:
  ...
  iadd R0, R1
  ige R0, 0
  jf R0, __LogicalAnd_ShortCircuit_2487
  mov R1, [BP-3]
  mov R2, [BP-4]
  mov R3, [BP-10]
  imul R2, R3
  ...
  ile R1, 350
  and R0, R1
__LogicalAnd_ShortCircuit_2487:
  jf R0, __if_2478_end
  mov R0, [BP-3]
  mov R1, [BP-4]
  mov R2, [BP-10]
...
__if_2514_start:
  mov R1, [BP-42]
  mov R0, [R1]
  mov R1, [global_randomValue]
  ieq R0, R1
  jf R0, __if_2514_else
  mov R0, 1
  mov [BP-7], R0
  mov R0, 0
  mov [BP-6], R0
...
__if_2529_start:
  ...
  mov R1, [global_randomValue]
  ilt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_2536
  mov R1, [BP-7]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_2536:
  jf R0, __if_2529_else
  mov R0, 1
  mov [BP-6], R0
  mov R0, 0
  mov [BP-5], R0
...
__if_2549_start:
  ...
  mov R1, [global_randomValue]
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_2556
  mov R1, [BP-7]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_2556:
  jf R0, __if_2549_end
  mov R0, 1
  mov [BP-5], R0
  mov R0, 0
...
__if_2569_start:
  mov R0, [BP-8]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_2575
  mov R1, [BP-7]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_2575:
  jf R0, __if_2569_end
  mov R1, [BP-1]
  mov [SP], R1
  mov R2, [BP-42]
...
__literal_string_1825:
  string "0"
__literal_string_2589:
  string "^"
__literal_string_2593:
  string "Welcom to Binary Search!"
__literal_string_2597:
  string "Try to guess the\n random number!"
__literal_string_2601:
  string "Remaining Guesses:"
__literal_string_2632:
  string "Guess Higher!"
__literal_string_2639:
  string "Guess Lower!"
__literal_string_2646:
  string "YON WON!"
__literal_string_2655:
  string "YOU LOST!"
